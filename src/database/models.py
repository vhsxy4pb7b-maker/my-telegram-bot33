...
class Customer(Base):
    ...
    # 平台相关字段
    platform = Column(Enum(Platform), default=Platform.FACEBOOK, nullable=False, index=True)
...
class Conversation(Base):
    ...
    collected_data = relationship("CollectedData", back_populates="conversation")
