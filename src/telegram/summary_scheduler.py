...
from src.database.models import Conversation, CustomerInteraction, Customer
...
class SummaryScheduler:
    ...
    def __init__(self, db: Session):
        ...
        self.notifications_config = yaml_config.get("telegram", {}).get("notifications", {})
        self.running = False
    ...
    async def _run_scheduler(self):
        ...
        try:
            ...
            logger.error(f"Error in summary scheduler: {str(e)}", exc_info=True)
    ...
    async def _wait_for_next_schedule(self):
        ...
        if frequency == "hourly":
            ...
            # 每天发送，等待到指定时间
            summary_time_str = self.notifications_config.get("summary_time", "09:00")
